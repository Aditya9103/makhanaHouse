            ...
            <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
                <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-6 lg:gap-8">
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-3 text-sm text-[var(--color-text-secondary)]">
                            <li><Link to="/shop" className="hover:text-[#d4af37]">Premium Makhana</Link></li>
                            <li><Link to="/shop" className="hover:text-[#d4af37]">Roasted Makhana</Link></li>
                            <li><Link to="/shop" className="hover:text-[#d4af37]">Flavored Makhana</Link></li>
                            <li><Link to="/export" className="hover:text-[#d4af37]">Bulk Makhana</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="flex flex-col gap-3 text-sm text-[var(--color-text-secondary)]">
                            <li><Link to="/export" className="hover:text-[#d4af37]">Bulk Orders</Link></li>
                            <li><Link to="/export" className="hover:text-[#d4af37]">Private Label</Link></li>
                            <li><Link to="/export" className="hover:text-[#d4af37]">Worldwide Shipping</Link></li>
                            <li><Link to="/export/new" className="hover:text-[#d4af37]">Export Inquiry</Link></li>
                        </ul>
                    </div>
