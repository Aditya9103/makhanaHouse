...
export default function AboutHero() {
    return (
        <section
            className="relative flex w-full items-center justify-center bg-[#080b14] bg-[length:100%_100%] bg-center bg-no-repeat lg:bg-[length:100%_auto]"
            style={{
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#080b14] via-[#080b14]/80 via-40% to-transparent"></div>

            <div className="relative z-10 mx-auto w-full max-w-[1400px] px-6 py-20 lg:px-10 lg:py-32">
