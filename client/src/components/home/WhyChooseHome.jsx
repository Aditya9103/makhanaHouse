    ...
    return (
        <section className="py-16 lg:py-24 bg-transparent">
            <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
                ...
                >
                    {/* Gradient overlay to make text readable but keep image fully visible */}
                    <div className="absolute inset-0 bg-gradient-to-b from-[#080b14] via-[#080b14]/95 to-transparent lg:bg-gradient-to-r lg:from-[#080b14] lg:via-[#080b14]/80 lg:to-transparent"></div>
                    ...
                    {/* Right - Mithila Text */}
                    <div className="relative z-10 flex w-full flex-col items-center lg:items-start justify-end px-6 pb-6 pt-16 lg:w-[22%] lg:p-0 lg:pb-16 lg:pr-8 text-center lg:text-left">
                        <div className="rounded-xl bg-white/20 p-4 backdrop-blur-md border border-white/40 shadow-xl max-w-[200px] lg:max-w-full">
                            <h3 className="mb-2 font-serif text-base sm:text-lg text-[#080b14] font-semibold leading-tight">
                                From the Land<br />of Mithila
                            </h3>
                            <p className="text-[10px] lg:text-[11px] leading-relaxed text-[#080b14]/80 font-medium">
                                Grown by local farmers in the pristine wetlands of Bihar using traditional methods.
                            </p>
                        </div>
                    </div>
